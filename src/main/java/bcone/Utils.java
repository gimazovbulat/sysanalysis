...
public class Utils {
    ...
    public static KeyPair loadKeys() throws Exception {
        ...
        byte[] publicKeyHex = Files.readAllBytes(Paths.get("C:\\Users\\User\\Downloads\\Telegram Desktop\\sysanalysis\\sysanalysis\\publik.key"));
        byte[] privateKeyHex = Files.readAllBytes(Paths.get("C:\\Users\\User\\Downloads\\Telegram Desktop\\sysanalysis\\sysanalysis\\private.key"));
